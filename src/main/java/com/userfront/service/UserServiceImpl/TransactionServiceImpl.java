...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void betweenAccountsTransfer(String transferFrom, String transferTo, BigDecimal amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) throws Exception {
        if (transferFrom.equalsIgnoreCase(AccountType.PRIMARY_ACCOUNT.getAccountType()) && transferTo.equalsIgnoreCase(AccountType.SAVING_ACCOUNT.getAccountType())) {
        ...
        } else if (transferFrom.equalsIgnoreCase(AccountType.SAVING_ACCOUNT.getAccountType()) && transferTo.equalsIgnoreCase(AccountType.PRIMARY_ACCOUNT.getAccountType())) {
    ...
    public void toSomeoneElseTransfer(Recipient recipient, String accountType, String amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) {
        if (accountType.equalsIgnoreCase(AccountType.PRIMARY_ACCOUNT.getAccountType())) {
            ...
            primaryTransactionDao.save(primaryTransaction);
        } else if (accountType.equalsIgnoreCase(AccountType.SAVING_ACCOUNT.getAccountType())) {
